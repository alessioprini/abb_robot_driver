...
> :warning: **Included packages works only with the [abb_libegm](https://github.com/alessioprini/abb_libegm), [abb_librws](https://github.com/alessioprini/abb_librws), and [abb_egm_rws_managers](https://github.com/alessioprini/abb_egm_rws_managers) fork from the same author!**
